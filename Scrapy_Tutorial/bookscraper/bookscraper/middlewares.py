...
class RandomUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_user_agents_active = settings.get("SCRAPEOPS_USER_AGENTS_ACTIVE")
    ...
    def process_request(self, request, spider):
        # Before sending the request modify the user agent header
        random_user_agent = self._get_random_user_agent()
        request.headers["User-Agent"] = random_user_agent
        print("*" * 50+" A New Header Has Been Added "+"*" * 50)
...
class FakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):
        # Before sending the request modify the header
        random_header = self._get_random_header()

        # Modify the request headers before sending the request
